...
<head>
    <title>Code coverage report for src/sso/ServerContextHandleManager.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sso</a> ServerContextHandleManager.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { CtxtHandle } from '../../lib/api';
...
&nbsp;
  constructor(private <span class="missing-if-branch" title="if path not taken" >I</span>delayMax = 20000) {}
&nbsp;
...
&nbsp;
  waitForReleased(cookieToken: CookieToken): Promise&lt;void&gt; {
    ...
    return new Promise((resolve, reject) =&gt; {
      ...
      const timeout = setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.tooLate(authItem);</span>
      }, this.delayMax);
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.authItem) {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  tooLate(</span>authItem: AuthItem): void {
<span class="cstat-no" title="statement not covered" >    while (this.queue.length &gt; 0) {</span>
      const ai = <span class="cstat-no" title="statement not covered" >this.queue.shift();</span>
<span class="cstat-no" title="statement not covered" >      clearTimeout(ai.timeout);</span>
<span class="cstat-no" title="statement not covered" >      this.authItem.reject();</span>
    }
<span class="cstat-no" title="statement not covered" >    this.authItem = authItem;</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Jul 15 2020 14:48:42 GMT+0200 (GMT+02:00)
            </div>
        </div>
