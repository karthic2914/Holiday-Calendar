...
<head>
    <title>Code coverage report for src/sso/schm/SCHMWithCookies.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/sso/schm</a> SCHMWithCookies.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { IncomingMessage, ServerResponse } from 'http';
...
&nbsp;
  getMethod(cookieToken: CookieToken): SSOMethod {
    ...
    return contextInfo<span class="branch-0 cbranch-no" title="branch not covered" >?.m</span>ethod;
  }
&nbsp;
  setMethod(ssoMethod: SSOMethod, cookieToken: CookieToken): void {
    const contextInfo = this.sessionMap.get(cookieToken);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!contextInfo) {
...
&nbsp;
  getHandle(cookieToken: CookieToken): CtxtHandle | undefined {
    ...
    const contextInfo = this.sessionMap.get(cookieToken);
    return contextInfo<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>erverContextHandle;
  }
&nbsp;
