...
<head>
    <title>Code coverage report for src/sso/adConnection.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sso</a> adConnection.ts</h1>
        <div class='clearfix'>
...
export function openADConnection(): void {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (adConnection.counter &lt; 0) {
<span class="cstat-no" title="statement not covered" >    adConnection.counter = 0;</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (adConnection.counter === 0) {
