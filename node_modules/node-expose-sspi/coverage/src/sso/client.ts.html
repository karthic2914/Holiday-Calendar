...
<head>
    <title>Code coverage report for src/sso/client.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sso</a> client.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import fetch, { RequestInit, Response } from 'node-fetch';
...
const agent = (parsedURL: URL): http.Agent =&gt;
  parsedURL.protocol === 'http:' ? httpAgent : <span class="branch-1 cbranch-no" title="branch not covered" >httpsAgent;</span>
&nbsp;
/**
...
&nbsp;
   ...
   * @memberof Client
   */
<span class="fstat-no" title="function not covered" >  setTargetName(</span>targetName: string): void {
<span class="cstat-no" title="statement not covered" >    this.clientInfo.targetName = targetName;</span>
  }
&nbsp;
  /**
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (authHeader === null) {
<span class="cstat-no" title="statement not covered" >      debug('no header www-authenticate');</span>
