...
<head>
    <title>Code coverage report for src/sso/client/misc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/sso/client</a> misc.ts</h1>
        <div class='clearfix'>
...
export async function getSPNFromURI(url: string): Promise&lt;string&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (msDomainName.length === 0) {
<span class="cstat-no" title="statement not covered" >    debug('Client running on a host that is not part of a Microsoft domain');</span>
<span class="cstat-no" title="statement not covered" >    return 'whatever';</span>
  }
...
<span class="cstat-no" title="statement not covered" >      debug('records', records);</span>
<span class="cstat-no" title="statement not covered" >      if (records.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
      }
<span class="cstat-no" title="statement not covered" >      hostname = records[0];</span>
    }
  } catch (e) {
    debug('DNS error', e);
  }
