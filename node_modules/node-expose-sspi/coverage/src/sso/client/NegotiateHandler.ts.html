...
<head>
    <title>Code coverage report for src/sso/client/NegotiateHandler.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/sso/client</a> NegotiateHandler.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    const targetName =
      clientInfo.targetName === undefined
        ...
        : <span class="branch-1 cbranch-no" title="branch not covered" >clientInfo.targetName;</span>
    ...
    while (
      ...
      if (clientSecurityContext) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!wwwAuthenticateHeader.startsWith(this.authenticationType + ' ')) {
...
<span class="cstat-no" title="statement not covered" >        debug('you should not see this');</span>
      }
