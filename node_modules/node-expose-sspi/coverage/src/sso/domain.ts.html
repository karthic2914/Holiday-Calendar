...
<head>
    <title>Code coverage report for src/sso/domain.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sso</a> domain.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { sspi, sysinfo, adsi } from '../../lib/api';
...
<span class="branch-1 cbranch-no" title="branch not covered" >    ds?.Release();</span>
<span class="branch-1 cbranch-no" title="branch not covered" >    element?.Release();</span>
    gc<span class="branch-0 cbranch-no" title="branch not covered" >?.R</span>elease();
    closeADConnection();
  }
