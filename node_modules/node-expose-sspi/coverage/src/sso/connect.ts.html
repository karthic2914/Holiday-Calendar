...
<head>
    <title>Code coverage report for src/sso/connect.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sso</a> connect.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { hexDump } from './misc';
import {
  sspi,
  UserCredential,
  SecurityContext,
...
&nbsp;
      if (serverSecurityContext) {
        ...
        clientInput.contextHandle = clientSecurityContext<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>ontextHandle;
      }
...
&nbsp;
      ...
      if (
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (serverSecurityContext.SECURITY_STATUS === 'SEC_E_LOGON_DENIED') {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (serverSecurityContext.SECURITY_STATUS !== 'SEC_E_OK') {
        continue;
      }
      // we have the security context !!!
<span class="cstat-no" title="statement not covered" >      debug('We have the security context !!!');</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    }
&nbsp;
    const sso = <span class="cstat-no" title="statement not covered" >new SSO(serverSecurityContext.contextHandle, undefined);</span>
<span class="cstat-no" title="statement not covered" >    await sso.load();</span>
<span class="cstat-no" title="statement not covered" >    if (sso.user.name === 'Guest') {</span>
<span class="cstat-no" title="statement not covered" >      throw badLoginPasswordError;</span>
    }
<span class="cstat-no" title="statement not covered" >    return sso;</span>
  } catch (e) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (e === badLoginPasswordError) {
      throw e;
    }
