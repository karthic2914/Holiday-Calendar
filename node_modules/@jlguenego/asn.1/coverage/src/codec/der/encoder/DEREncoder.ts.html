...
<head>
    <title>Code coverage report for src/codec/der/encoder/DEREncoder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/codec/der/encoder</a> DEREncoder.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1Message} from '../../../interfaces/ASN1Message';
...
export function getTagClassBits(tagClass: TagClass) {
  switch (tagClass) {
    case TagClass.UNIVERSAL:
      return 0b0000_0000;
<span class="branch-1 cbranch-no" title="branch not covered" >    case TagClass.APPLICATION:</span>
<span class="cstat-no" title="statement not covered" >      return 0b0100_0000;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >    case TagClass.CONTEXT_SPECIFIC:</span>
<span class="cstat-no" title="statement not covered" >      return 0b1000_0000;</span>
<span class="branch-3 cbranch-no" title="branch not covered" >    case TagClass.PRIVATE:</span>
<span class="cstat-no" title="statement not covered" >      return 0b1100_0000;</span>
  }
}
&nbsp;
...
export function getLengthOctet(contentLength: number) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (contentLength &lt; 127) {
    return padHexString(contentLength.toString(16));
  }
  const end = <span class="cstat-no" title="statement not covered" >padHexString(contentLength.toString(16));</span>
<span class="cstat-no" title="statement not covered" >  return padHexString((end.length / 2).toString(16)) + end;</span>
}
&nbsp;
export function getContentOctet(m: ASN1Message): string {
  if (m.tagCode === TagUniversal.BOOLEAN.code) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (m.value === true) {
      return 'ff';
    } else <span class="cstat-no" title="statement not covered" >if (m.value === false) {</span>
<span class="cstat-no" title="statement not covered" >      return '00';</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (m.tagCode === TagUniversal.SEQUENCE.code) {
