...
<head>
    <title>Code coverage report for src/codec/ber/decoder/primitive/ReadBitString.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/codec/ber/decoder/primitive</a> ReadBitString.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('A bit string must have an initial octet (8.6.2)');</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (initialOctet &gt; 7) {
<span class="cstat-no" title="statement not covered" >    throw new Error('initial octet cannot be more than 7.');</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (length === 1) {
<span class="cstat-no" title="statement not covered" >    if (initialOctet !== 0) {</span>
