...
<head>
    <title>Code coverage report for src/codec/ber/decoder/misc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/codec/ber/decoder</a> misc.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">64x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {TagClass} from '../../../interfaces/TagClass';
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return TagClass.PRIVATE;</span>
<span class="branch-4 cbranch-no" title="branch not covered" >    default:</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('octet should be &lt; 128');</span>
  }
}
&nbsp;
