...
<head>
    <title>Code coverage report for src/codec/ber/decoder/BERDecoder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/codec/ber/decoder</a> BERDecoder.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {CursorDataView} from '../../../CursorDataView';
...
export function BERDecode(input: ArrayBuffer): ASN1Message {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (identifier.isComposed()) {
    return readComposed(cdv, identifier);
  }
<span class="cstat-no" title="statement not covered" >  return readSimple(cdv, identifier);</span>
}
&nbsp;
function readIdentifierOctets(cdv: CursorDataView): Identifier {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (result.tag &lt; 0b0001_1111) {
    return result;
  }
  // multi octets.
  let tagNumberStr = <span class="cstat-no" title="statement not covered" >'';</span>
  let octetN;
<span class="cstat-no" title="statement not covered" >  while (true) {</span>
<span class="cstat-no" title="statement not covered" >    octetN = cdv.read();</span>
    // bit 7 to 1 (8.1.2.4.2 b)
    const str = <span class="cstat-no" title="statement not covered" >(octetN &amp; 0b0111_1111).toString(2);</span>
<span class="cstat-no" title="statement not covered" >    console.log('str: ', str);</span>
<span class="cstat-no" title="statement not covered" >    tagNumberStr += str;</span>
    // last octet (8.1.2.4.2 a)
<span class="cstat-no" title="statement not covered" >    if ((octetN &amp; 0b1000_0000) === 0) {</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    }
  }
  // (8.1.2.4.2 b) concactenation
<span class="cstat-no" title="statement not covered" >  result.tag = parseInt(tagNumberStr, 2);</span>
...
function readLengthOctets(cdv: CursorDataView): BERLength {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (length === 0b1000_0000) {
<span class="cstat-no" title="statement not covered" >    return {type: LengthType.INDEFINITE, length: -1};</span>
  }
...
&nbsp;
  ...
  if (identifier.tag === TagUniversal.OBJECT_IDENTIFIER.code) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (identifier.constructed) {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (identifier.tag === TagUniversal.GENERAL_STRING.code) {
    result.value = readIA5String(cdv, length);
    return result;
  }
<span class="cstat-no" title="statement not covered" >  throw new Error(</span>
