...
<head>
    <title>Code coverage report for src/asn1/ASN1ModuleFactory.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/asn1</a> ASN1ModuleFactory.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1CstParser} from '../analysis/ASN1CstParser';
...
export class ASN1ModuleFactory {
  static compile(definition: string): ASN1Module {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parserInstance.errors.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      throw Error('Syntax error:\n' + parserInstance.errors[0].message);</span>
    }
