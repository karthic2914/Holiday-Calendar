...
<head>
    <title>Code coverage report for src/ASN1.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> ASN1.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1Module} from './asn1/ASN1Module';
...
export class ASN1 {
  static decode(
    ...
    opts: Partial&lt;ASN1ParserOptions&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{}</span>
  ) {
...
<span class="cstat-no" title="statement not covered" >      input = message;</span>
    }
&nbsp;
...
&nbsp;
  static encode(
    ...
    encodingRule = <span class="branch-0 cbranch-no" title="branch not covered" >EncodingRule.DER</span>
  ): Buffer {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (
      encodingRule === EncodingRule.DER ||
<span class="branch-1 cbranch-no" title="branch not covered" >      encodingRule === EncodingRule.BER</span>
    ) {
...
&nbsp;
  static generate(
    ...
    type: string,
    data: Props,
    opts: Partial&lt;ASN1GeneratorOptions&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{}</span>
  ): Buffer {
    const options = {
      encodingRule: EncodingRule.DER,
      inputFormat: 'json',
