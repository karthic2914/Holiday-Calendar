...
<head>
    <title>Code coverage report for src/ASN1Generator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> ASN1Generator.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1Assignment} from './asn1/ASN1Assignment';
...
&nbsp;
  generateFromAssignement(assignment: ASN1Assignment): ASN1Message {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (assignment.type instanceof ASN1Sequence) {
...
&nbsp;
  generateFromComponent(component: ASN1ComponentType): ASN1Message {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(component instanceof ASN1NamedType)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('only implement ASN1NamedType at this time');</span>
    }
    let message: ASN1Message;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (component.type instanceof ASN1Sequence) {
<span class="cstat-no" title="statement not covered" >      message = this.generateFromSequence(component.type);</span>
      ...
      switch (component.type.constructor.name) {
        ...
        case 'ASN1GeneralStringType':
          ...
          break;
<span class="branch-2 cbranch-no" title="branch not covered" >        case 'ASN1IA5StringType':</span>
<span class="cstat-no" title="statement not covered" >          message.tagLabel = TagUniversal.IA5STRING.label;</span>
<span class="cstat-no" title="statement not covered" >          message.tagCode = TagUniversal.IA5STRING.code;</span>
<span class="cstat-no" title="statement not covered" >          message.value = 'to be replaced';</span>
...
function generateFromJson(msg: ASN1Message, data: Props) {
  ...
  for (const key of Object.keys(data)) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cell === undefined) {
<span class="cstat-no" title="statement not covered" >      throw new Error('cell not found for key = ' + key);</span>
    }
