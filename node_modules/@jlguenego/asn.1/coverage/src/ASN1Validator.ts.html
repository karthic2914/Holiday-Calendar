...
<head>
    <title>Code coverage report for src/ASN1Validator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> ASN1Validator.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1ComponentType} from './asn1/ASN1ComponentType';
...
&nbsp;
  validateTaggedType(taggedType: ASN1TaggedType, input: ASN1Message) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (input.tagClass !== taggedType.tag.tagClass) {
...
<span class="cstat-no" title="statement not covered" >        throw new Error('limitation: cannot process only NamedType.');</span>
      }
...
&nbsp;
  validateComponent(component: ASN1ComponentType, input: ASN1Message) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(component instanceof ASN1NamedType)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('can process only ASN1NamedType');</span>
    }
&nbsp;
    if (component.type instanceof ASN1ChoiceType) {
      ...
      if (input.value !== null) {
        ...
        switch (name) {
<span class="branch-0 cbranch-no" title="branch not covered" >          case 'ASN1BooleanType':</span>
<span class="cstat-no" title="statement not covered" >            if (typeof input.value !== 'boolean') {</span>
<span class="cstat-no" title="statement not covered" >              throw new Error('must be an boolean');</span>
            }
<span class="cstat-no" title="statement not covered" >            break;</span>
          case 'ASN1IntegerType':
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!Number.isInteger(input.value)) {
<span class="cstat-no" title="statement not covered" >              throw new Error('must be an integer');</span>
            }
            break;
          case 'ASN1IA5StringType':
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof input.value !== 'string') {
<span class="cstat-no" title="statement not covered" >              throw new Error(`must be an string: ${input}`);</span>
            }
            break;
