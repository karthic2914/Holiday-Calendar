...
<head>
    <title>Code coverage report for src/analysis/ASN1Visitor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/analysis</a> ASN1Visitor.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// import {inspect} from 'util';
...
&nbsp;
  Type(ctx: TypeCstNode) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx.ReferencedType) {
...
&nbsp;
  ReferencedType(ctx: ReferencedTypeCstNode) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ctx.UsefulType) {
