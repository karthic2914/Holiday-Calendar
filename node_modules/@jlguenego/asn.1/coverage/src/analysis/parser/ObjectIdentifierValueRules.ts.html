...
<head>
    <title>Code coverage report for src/analysis/parser/ObjectIdentifierValueRules.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/analysis/parser</a> ObjectIdentifierValueRules.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {ASN1CstParser} from '../ASN1CstParser';
import {
  Identifier,
  L_CURLY,
  L_PARENTHESIS,
