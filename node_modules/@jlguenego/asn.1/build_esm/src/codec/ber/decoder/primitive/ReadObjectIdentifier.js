export function readObjectIdentifier(cdv, length) {
    ...
    for (let i = 0; i < length; i++) {
        ...
        if (subIdentifierValue === 0) {
            // leading octet.
            if (v === 0x80) {
                throw new Error('The subidentifier shall be encoded in the fewest possible octets. (8.19.2)');
            }
        }
        const value = v & 127;
    ...
    const firstSubIdentifier = array.shift();
