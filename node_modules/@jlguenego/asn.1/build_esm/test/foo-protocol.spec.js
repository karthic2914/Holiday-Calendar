...
describe('Foo Unit Test', () => {
    it('should parse the foo message', () => {
        const output = ASN1.decode(readFileSync(resolve(__dirname, 'data/foo-question.der'), {
            encoding: 'utf8',
        }), {
    ...
    it('should validate the fooQuestionDerJson according the ASN1 FooProtocol', () => {
        const definition = readFileSync(resolve(__dirname, 'data/foo-protocol.asn1'), { encoding: 'utf8' });
        const module = ASN1.getModuleFromStr(definition);
        const validatedJson = ASN1.validate(module, fooQuestionDerJson, 'FooQuestion');
        assert.deepStrictEqual(validatedJson, fooQuestionDerValidatedJson);
    });
});
//# sourceMappingURL=foo-protocol.spec.js.map